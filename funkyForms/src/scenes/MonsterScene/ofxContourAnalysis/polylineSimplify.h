...
//    ofPoint and Vector with
//        coordinates {float x, y, z;}    // as many as are needed
//        operators for:
//            == to test equality
//            != to test inequality
//            (Vector)0 = (0,0,0)         (null vector)
//            ofPoint  = ofPoint ± Vector
//            Vector = ofPoint - ofPoint
//            Vector = Vector ± Vector
//            Vector = Scalar * Vector    (scalar product)
//            Vector = Vector * Vector    (cross product)
//    Segment with defining endpoints {ofPoint P0, P1;}
//===================================================================
...
static int poly_simplify( float tol, ofPoint* V, int n, ofPoint* sV ){
