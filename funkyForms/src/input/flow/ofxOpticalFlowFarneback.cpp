...
void ofxOpticalFlowFarneback::setup(int width, int height,
    ...
    colrImgLrg.setUseTexture(false);
    colrImgSml.setUseTexture(false);
    greyImgLrg.setUseTexture(false);
    greyImgSml.setUseTexture(false);
    greyImgPrv.setUseTexture(false);
